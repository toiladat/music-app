...
route.patch('/like', auth_middlewares_1.requireAuth, controller.like);
route.patch('/favorite', auth_middlewares_1.requireAuth, controller.favoritePatch);
route.get('/favorite', auth_middlewares_1.requireAuth, controller.favorite);
route.get('/search/:type', controller.search);
route.patch('/listen', controller.listen);
exports.songRoute = route;
